...
/** @param {((input: RequestInfo | URL, init?: RequestInit) => Promise<Response>) | import("h3").FetchHandler} f  */
function setRequest(f) {
    if(!f) f = globalThis.fetch;
    fetch = f;
}
